...
<body class="bg-gray-100 text-gray-900">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <aside id="sidebar"
            class="w-64 bg-purple-700 text-white flex flex-col p-4 space-y-6 transform -translate-x-full md:translate-x-0 transition-transform duration-200 ease-in-out z-20 fixed md:relative h-full">

            <h2 class="text-2xl font-bold mb-8 flex items-center gap-2">
                <i data-lucide="trending-up"></i> Sales Analyst
            </h2>
